     ...
     id='project' className='mt-20'>
      ...
      <div className='flex mt-10 justify-center p-5 gap-10'>
        ...
        <div className='flex flex-col p-5 rounded-lg dark:bg-gray-950 bg-gray-50 shadow-2xl shadow-gray-300 dark:shadow-gray-900'>
            ...
            <h1 className='text-[20px] font-normal mt-2 dark:text-white'>My Personal Portfolio</h1>
            <p className='text-[15px] text-gray-500 mt-3'>Tech: Frontend Project - ReactJS, Tailwind CSS, Framer Motion</p>
        </div>
      </div>
      </div>
    </motion.div>
