  ...
  return (
    <div id='contact' className='mt-10 p-5 w-full max-w-9xl'>
      ...
      <div className='w-full max-w-8xl p-5 flex justify-center'>
        ...
        viewport={{ once: true }}
        className=' size-100'><img src={contact} alt="" /></motion.div>
        <div className='flex flex-col gap-5 items-center justify-center'>
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
             ref={formRef} onSubmit={sendEmail} className='flex items-start flex-col gap-3 p-4 bg-white dark:bg-gray-950 rounded-lg'>
