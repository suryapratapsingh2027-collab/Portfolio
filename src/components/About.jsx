...
const About = () => {
  return (
    <div id='about' className='mt-10 p-5 w-full max-w-9xl md:mt-50 '>
      ...
      <div className='flex flex-col justify-center items-center p-5 gap-5 md:justify-around md:flex-row  mt-10'>
        <div className=' rounded-full w-1/4 justify-center flex object-cover'>
      ...
      <div className=' md:w-2/3 p-4 flex flex-col md:items-start items-center'>
        ...
        <span className='px-5 py-2 text-purple-700 md:text-[12px] text-[15px] dark:border-purple-400 rounded-lg dark:bg-purple-400 bg-purple-200'>Full Stack Developer</span>
